...
class _SectionsApi implements SectionsApi {
  _SectionsApi(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<Section> getSection(int id) async {
    ...
    final _options = _setStreamType<Section>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late Section _value;
    try {
      _value = Section.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<List<Section>> getSectionsByUser(String userId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Section>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
