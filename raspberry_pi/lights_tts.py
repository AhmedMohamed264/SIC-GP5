...
class TTSSpeaker:
    # Bismillah
    def _init_(self, port='/dev/ttyS0', baud_rate=115200, timeout=1):
...
class SmartHome:
    def _init_(self, trigger_pin, echo_pin, led_pin):
        # Bismillah
...
# testing
if _name_ == "_main_":
    tts = TTSSpeaker(port='/dev/ttyS0', baud_rate=115200)
    smarthome = SmartHome(trigger_pin=21, echo_pin=20, led_pin=26)
    ...
    while True:
        ...
        if distance < 30:
            ...
            print(tts.send_text("Motion detected"))
