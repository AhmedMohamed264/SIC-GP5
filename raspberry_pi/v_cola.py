...
# Define GPIO pins
TRIG_PIN = 21  # Pin for TRIG on the ultrasonic sensor
ECHO_PIN = 20  # Pin for ECHO on the ultrasonic sensor
PUMP_PIN = 16  # Pin for controlling the water pump
...
try:
    while True:
        ...
        sleep(0.2)  # Wait for 1 second before taking the next reading
